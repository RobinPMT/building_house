...
{{--                <h5 class="modal-title" id="exampleModalLabel">{{ isset($category->id) ? "Cập nhật" : "Thêm mới" }}</h5>--}}
            ...
            <div class="modal-body flex-grow-1">
                <div class="form-group">
                    ...
                    <input type="text" name="value" class="form-control dt-full-name" id="title" placeholder="Tiêu đề" aria-label="Tiêu đề" required/>
                </div>
                ...
                <div class="form-group">
                    <label for="input_image">Ảnh <strong>(Kích thước: 1520x907 pixel)</strong> <span style="color: red">*</span></label>
