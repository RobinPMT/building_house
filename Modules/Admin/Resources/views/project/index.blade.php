...
{{--                                <td scope="row">{{$stt + 1}}</td>--}}
                                ...
                                <td style="">
                                    <a class="badge badge-pill badge-light-primary item-detail" href="{{route('admin.delete.images.project', [$item['id'], ''])}}" data-title="{{$item['title']}}" data-arr-images="{{$item['arr_image']}}" data-toggle="modal" data-target="#detail-image">
...
{{--                                <td style="">{{$item['creator']['name']}}</td>--}}
                                <td style="">
                                    <a class="badge badge-pill {{$item['arr_active']['class']}}" href="{{route('admin.get.action.project', ['active', $item['id']])}}">
                                        {{$item['arr_active']['name']}}
                                    </a>
                                </td>
                                <td style="">
                                    <a class="badge badge-pill {{$item['arr_hot']['class']}}" href="{{route('admin.get.action.project', ['hot', $item['id']])}}">
                                        {{$item['arr_hot']['name']}}
                                    </a>
                                </td>
                                <td style="display: none;">
{{--                                    <a href="#" class="item-detail" data-title="{{$item['title']}}" data-content="{{$item['content']}}" data-toggle="modal" data-target="#detail-project">--}}
...
{{--                                    </a>--}}
                                    <a href="{{route('admin.get.action.project', ['delete', $item['id']])}}" class="delete-record"  id="confirm-color" data-id="{{$item['id']}}">
                                        <svg
                                    ...
                                    <a href="{{route('admin.get.find.project', $item['id'])}}" data-url-update="{{route('admin.update.project', $item['id'])}}" class="item-edit" data-toggle="modal" data-target="#modals-slide-in">
