...
{{--                </select>--}}
    ...
    <section class="section-page">
        <div class="container">
            ...
            @if(isset($rooms))
                @foreach($rooms as $room)
                    <div class="row-design not-active" id="tabid{{$room->id}}">
    ...
    <script defer>
        ...
        $(document).ready(function(){
            ...
            $('.other-design-item').click(function(){
                ...
                if (result_arr_system.length) {
                    for (let i = 0; i < result_arr_system.length; i++){
                        if(result_arr_system[i]['key'] === key) {
                            console.log(1);
                            result_arr_system.splice(i, 1);
                        } else {
                            result_arr_system.push({
                                'room_id' : room_id,
                                'attribute_id' : attribute_id,
                                'key' : key,
                            });
            ...
            $('#submit-data').click(function(e){
                ...
                data['arr_style'] = result_arr_style;
