                ...
                @if(isset($post))
                    <div class="col-lg-9 col-md-8">
                        ...
                        <div class="article-sharing">
                            ...
                            <a class="share" href="https://www.facebook.com/sharer/sharer.php?u={{route('get.detail.post', [$post->slug])}}" target="_blank" rel="nofollow" title="Facebook">
                            ...
                            <a class="share" href="https://plus.google.com/share?url={{route('get.detail.post', [$post->slug])}}" target="_blank" rel="nofollow" title="Google +">
                            ...
                            <a class="share" href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{route('get.detail.post', [$post->slug])}}" target="_blank" rel="nofollow" title="LinkedIn">
                            ...
                            @foreach($postsRelated as $key => $postRelated)
                                <div class="col-md-12 col-sm-4 col-xss-6 news-item">
                                    <div class="news-item-ct">
                                        <a href="{{route('get.detail.post', [$postRelated->slug])}}" class="news-thumb"><img class="lazyload" src="{{asset('fe_template/images/loading.gif')}}" data-src="{{imageUrl(pare_url_file($postRelated->avatar, 'posts'), 480, 330, 100, 1)}}" alt="480x330" /></a>
                                        <div class="news-short">
                                            <a href="{{route('get.detail.post', [$postRelated->slug])}}" class="news-title limit-two-line">{{$postRelated->title}}</a>
